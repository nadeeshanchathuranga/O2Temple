        ...
        <DialogHeader className="flex items-center gap-3 p-4 sm:p-6 pb-4 border-b border-gray-100">
          <div className="flex items-center gap-3 w-full">
            ...
            <div className="flex-1">
              <DialogTitle className="text-base sm:text-lg font-semibold text-gray-900">Create Customer</DialogTitle>
              <DialogDescription className="text-xs sm:text-sm text-gray-600 mt-0.5">
                Add a new customer to the system with their contact information.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
          ...
          <form onSubmit={handleSubmit} className="p-4 sm:p-6 bg-white overflow-y-auto max-h-[70vh] sm:max-h-[80vh]">
            <div className="space-y-4 sm:space-y-5">
              ...
              <div>
                <Label htmlFor="create_phone_2" className="text-sm font-medium text-gray-700 mb-1 sm:mb-2 block">
                  Phone 2 (Optional)
                </Label>
                <Input
                  id="create_phone_2"
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-3 mt-6">
              ...
              <Button
                type="submit"
                disabled={processing || (data.phone.length > 0 && data.phone.length !== 10)}
